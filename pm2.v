...
Proof.
    ...
    exact (mp S3 (mp S2 (syll (impl p q) (impl p (not (not q))) (impl (not q) (not p))))).
Qed.
...
Proof.
    ...
    exact (mp S3 (mp S1 (syll (impl (not q) (not p)) (impl p (not (not q))) (impl p q)))).
Qed.
...
Proof.
    ...
    pose (S4 := (mp S3 (mp S2 (syll (impl (not p) p) (impl (not p) (not (not p))) (not (not p)))))).
    pose (S5 := (pm2_14 p)).
    exact (mp S5 (mp S4 (syll (impl (not p) p) (not (not p)) p))).
Qed.
...
Proof.
    ...
    pose (S1 := (add q p)).
    pose (S2 := (perm q p)).
    exact (mp S2 (mp S1 (syll p (or q p) (or p q)))).
Qed.
...
Proof.
    intros.
    exact (mp (pm2_21 p q) (comm (not p) p q)).
Qed.
...
Proof.
    ...
    exact (mp S1 (pm1_5 (not (or p q)) p q)).
Qed.
...
Proof.
    intros.
    pose (S1 := (perm q r)).
    exact (mp S1 (sum p (or q r) (or r q))).
Qed.
...
Proof.
    ...
    pose (S2 := (mp (assoc r p q) (mp S1 (syll (or (or p q) r) (or r (or p q)) (or p (or r q)))))).
    exact (mp (pm2_3 p r q) (mp S2 (syll (or (or p q) r) (or p (or r q)) (or p (or q r))))).
Qed.
...
Proof.
    intros.
    pose (S1 := (perm p r)).
    pose (S2 := (mp S1 (syllr (or p q) (or p r) (or r p)))).
    pose (S3 := (sum p q r)).
    exact (mp S2 (mp S3 (syll (impl q r) (impl (or p q) (or p r)) (impl (or p q) (or r p))))).
Qed.
...
Proof.
    intros.
    pose (S1 := (perm q p)).
    pose (S2 := (mp S1 (syll (or q p) (or p q) (or p r)))).
    pose (S3 := (sum p q r)).
    exact (mp S2 (mp S3 (syll (impl q r) (impl (or p q) (or p r)) (impl (or q p) (or p r))))).
Qed.
...
Proof.
    intros.
    pose (S1 := (perm q p)).
    pose (S2 := (mp S1 (syll (or q p) (or p q) (or r p)))).
    pose (S3 := (pm2_36 p q r)).
    exact (mp S2 (mp S3 (syll (impl q r) (impl (or p q) (or r p)) (impl (or q p) (or r p))))).
Qed.
...
Proof.
    ...
    exact (mp (mp (taut p) (pm2_38 q (or p p) p)) (mp S1 (syll (or p (or p q)) (or (or p p) q) (or p q)))).
Qed.
...
Proof.
    intros.
    pose (S1 := (assoc q p q)).
    exact (mp (mp (taut q) (sum p (or q q) q)) (mp S1 (syll (or q (or p q)) (or p (or q q)) (or p q)))).
Qed.
...
Proof.
    intros.
    exact (mp (pm2_2 p q) (transp0 p (or p q))).
Qed.

Theorem pm2_46 : forall (p q : Prop), (impl (not (or p q)) (not q)).
Proof.
    intros.
    exact (mp (pm1_3 p q) (transp0 q (or p q))).
Qed.

Theorem pm2_47 : forall (p q : Prop), (impl (not (or p q)) (or (not p) q)).
Proof.
    intros.
    exact (mp (pm2_2 (not p) q) (mp (pm2_45 p q) (syll (not (or p q)) (not p) (or (not p) q)))).
Qed.

Theorem pm2_48 : forall (p q : Prop), (impl (not (or p q)) (or p (not q))).
Proof.
    intros.
    exact (mp (pm1_3 p (not q)) (mp (pm2_46 p q) (syll (not (or p q)) (not q) (or p (not q))))).
Qed.

Theorem pm2_49 : forall (p q : Prop), (impl (not (or p q)) (or (not p) (not q))).
Proof.
    intros.
    exact (mp (pm2_2 (not p) (not q)) (mp (pm2_45 p q) (syll (not (or p q)) (not p) (or (not p) (not q))))).
Qed.
...
Proof.
    intros.
    exact (mp (pm2_17 q p) (mp (pm2_52 p q) (syll (not (impl p q)) (impl (not p) (not q)) (impl q p)))).
Qed.
...
Proof.
    intros.
    exact (mp (pm2_53 p q) (comm (or p q) (not p) q)).
Qed.

Theorem pm2_56 : forall (p q : Prop), (impl (not q) (impl (or p q) p)).
Proof.
    intros.
    exact (mp (mp (perm p q) (syll (or p q) (or q p) p)) (mp (pm2_55 q p) (syll (not q) (impl (or q p) p) (impl (or p q) p)))).
Qed.
...
Proof.
    ...
    pose (S2 := (mp (taut q) (syllr (or (not p) q) (or q q) q))).
    exact (mp S2 (mp S1 (syll (impl (not p) q) (impl (or (not p) q) (or q q)) (impl (or (not p) q) q)))).
Qed.

Theorem pm2_61 : forall (p q : Prop), (impl (impl p q) (impl (impl (not p) q) q)).
Proof.
    intros.
    exact (mp (pm2_6 p q) (comm (impl (not p) q) (impl p q) q)).
Qed.

Theorem pm2_62 : forall (p q : Prop), (impl (or p q) (impl (impl p q) q)).
Proof.
    intros.
    exact (mp (pm2_6 p q) (mp (pm2_53 p q) (syll (or p q) (impl (not p) q) (impl (impl p q) q)))).
Qed.

Theorem pm2_621 : forall (p q : Prop), (impl (impl p q) (impl (or p q) q)).
Proof.
    intros.
    exact (mp (pm2_62 p q) (comm (or p q) (impl p q) q)).
Qed.
...
Proof.
    intros.
    exact (mp (mp (mp (perm p (not q)) (syll (or p (not q)) (or (not q) p) p)) (mp (pm2_63 q p) (syll (or q p) (impl (or (not q) p) p) (impl (or p (not q)) p)))) (mp (perm p q) (syll (or p q) (or q p) (impl (or p (not q)) p)))).
Qed.
...
Proof.
    intros.
    pose (S1 := (mp (pm2_54 p q) (syll (impl (not p) q) (or p q) q))).
    pose (S2 := (mp (pm2_24 p q) (syll p (impl (not p) q) q))).
    exact (mp S2 (mp S1 (syll (impl (or p q) q) (impl (impl (not p) q) q) (impl p q)))).
Qed.
...
Proof.
    ...
    exact (mp (pm2_54 p q) (mp S1 (syll (impl (impl p q) q) (impl (not p) q) (or p q)))).
Qed.

Theorem pm2_69 : forall (p q : Prop), (impl (impl (impl p q) q) (impl (impl q p) p)).
Proof.
    intros.
    exact (mp (pm2_62 q p) (mp (mp (perm p q) (mp (pm2_68 p q) (syll (impl (impl p q) q) (or p q) (or q p)))) (syll (impl (impl p q) q) (or q p) (impl (impl q p) p)))).
Qed.

Theorem pm2_73 : forall (p q r : Prop), (impl (impl p q) (impl (or3 p q r) (or q r))).
Proof.
    intros.
    exact (mp (pm2_38 r (or p q) q) (mp (pm2_621 p q) (syll (impl p q) (impl (or p q) q) (impl (or3 p q r) (or q r))))).
Qed.

Theorem pm2_74 : forall (p q r : Prop), (impl (impl q p) (impl (or3 p q r) (or p r))).
Proof.
    intros.
    exact (mp (mp (mp (perm p q) (pm2_38 r (or p q) (or q p))) (syll (or3 p q r) (or3 q p r) (or p r))) (mp (pm2_73 q p r) (syll (impl q p) (impl (or3 q p r) (or p r)) (impl (or3 p q r) (or p r))))).
Qed.

Theorem pm2_75 : forall (p q r : Prop), (impl (or p q) (impl (or p (impl q r)) (or p r))).
Proof.
    intros.
    exact (mp (mp (pm2_31 p (not q) r) (syll (or p (impl q r)) (or3 p (not q) r) (or p r))) (mp (mp (mp (pm2_74 p (not q) r) (mp (pm2_53 q p) (syll (or q p) (impl (not q) p) (impl (or3 p (not q) r) (or p r))))) (mp (perm p q) (syll (or p q) (or q p) (impl (or3 p (not q) r) (or p r))))) (syll (or p q) (impl (or3 p (not q) r) (or p r)) (impl (or p (impl q r)) (or p r))))).
Qed.

Theorem pm2_76 : forall (p q r : Prop), (impl (or p (impl q r)) (impl (or p q) (or p r))).
Proof.
    intros.
    exact (mp (pm2_75 p q r) (comm (or p q) (or p (impl q r)) (or p r))).
Qed.
...
Proof.
    intros.
    pose (S1 := (mp (pm2_53 r q) (mp (perm q r) (syll (or q r) (or r q) (impl (not r) q))))).
    exact (mp (pm2_38 s (not r) q) (mp S1 (syll (or q r) (impl (not r) q) (impl (or (not r) s) (or q s))))).
Qed.
...
Proof.
    ...
    pose (S2 := (mp (pm2_76 p r s) (syllr (or p q) (or p (impl r s)) (impl (or p r) (or p s))))).
    exact (mp S2 (mp S1 (syll (impl q (impl r s)) (impl (or p q) (or p (impl r s))) (impl (or p q) (impl (or p r) (or p s)))))).
Qed.

Theorem pm2_82 : forall (p q r s : Prop), (impl (or3 p q r) (impl (or3 p (not r) s) (or3 p q s))).
Proof.
    intros.
    exact (mp (mp (mp (mp (pm2_32 p (not r) s) (syll (or3 p (not r) s) (or p (or (not r) s)) (or3 p q s))) (mp (mp (pm2_31 p q s) (syllr (or p (or (not r) s)) (or p (or q s)) (or3 p q s))) (syll (impl (or p (or (not r) s)) (or p (or q s))) (impl (or p (or (not r) s)) (or3 p q s)) (impl (or3 p (not r) s) (or3 p q s))))) (mp (mp (pm2_8 q r s) (pm2_81 p (or q r) (or (not r) s) (or q s))) (syll (or p (or q r)) (impl (or p (or (not r) s)) (or p (or q s))) (impl (or3 p (not r) s) (or3 p q s))))) (mp (pm2_32 p q r) (syll (or3 p q r) (or p (or q r)) (impl (or3 p (not r) s) (or3 p q s))))).
Qed.

Theorem pm2_83 : forall (p q r s : Prop), (impl (impl p (impl q r)) (impl (impl p (impl r s)) (impl p (impl q s)))).
Proof.
    intros.
    exact (mp (mp (mp (mp (pm2_31 (not p) (not r) s) (syll (impl p (impl r s)) (or3 (not p) (not r) s) (impl p (impl q s)))) (mp (mp (pm2_32 (not p) (not q) s) (syllr (or3 (not p) (not r) s) (or3 (not p) (not q) s) (impl p (impl q s)))) (syll (impl (or3 (not p) (not r) s) (or3 (not p) (not q) s)) (impl (or3 (not p) (not r) s) (impl p (impl q s))) (impl (impl p (impl r s)) (impl p (impl q s)))))) (mp (pm2_82 (not p) (not q) r s) (syll (or3 (not p) (not q) r) (impl (or3 (not p) (not r) s) (or3 (not p) (not q) s)) (impl (impl p (impl r s)) (impl p (impl q s)))))) (mp (pm2_31 (not p) (not q) r) (syll (impl p (impl q r)) (or3 (not p) (not q) r) (impl (impl p (impl r s)) (impl p (impl q s)))))).
Qed.

Theorem pm2_85 : forall (p q r : Prop), (impl (impl (or p q) (or p r)) (or p (impl q r))).
Proof.
    intros.
    pose (S1 := (mp (add p q) (syll q (or p q) r))).
    pose (S2 := (pm2_55 p r)).
    pose (S3 := (mp (syllr (or p q) (or p r) r) (mp S2 (syll (not p) (impl (or p r) r) (impl (impl (or p q) (or p r)) (impl (or p q) r)))))).
    pose (S4 := (mp (mp S1 (syllr (impl (or p q) (or p r)) (impl (or p q) r) (impl q r))) (mp S3 (syll (not p) (impl (impl (or p q) (or p r)) (impl (or p q) r)) (impl (impl (or p q) (or p r)) (impl q r)))))).
    pose (S5 := (mp S4 (comm (not p) (impl (or p q) (or p r)) (impl q r)))).
    exact (mp (pm2_54 p (impl q r)) (mp S5 (syll (impl (or p q) (or p r)) (impl (not p) (impl q r)) (or p (impl q r))))).
Qed.
